...
pub const TraceHooks = extern struct {
    ...
    append_buffer: ?fn(Buffer, [*c]const Range, i32, ?*c_void) callconv(.C) void = null,
    ...
    apply_uniforms: ?fn(ShaderStage, i32, [*c]const Range, ?*c_void) callconv(.C) void = null,
