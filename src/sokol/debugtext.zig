...
pub extern fn sdtx_font(i32) void;
pub fn font(font_index: i32) callconv(.Inline) void {
    sdtx_font(font_index);
}
pub extern fn sdtx_canvas(f32, f32) void;
pub fn canvas(w: f32, h: f32) callconv(.Inline) void {
    sdtx_canvas(w, h);
}
pub extern fn sdtx_origin(f32, f32) void;
pub fn origin(x: f32, y: f32) callconv(.Inline) void {
    sdtx_origin(x, y);
}
pub extern fn sdtx_home() void;
pub fn home() callconv(.Inline) void {
    sdtx_home();
}
pub extern fn sdtx_pos(f32, f32) void;
pub fn pos(x: f32, y: f32) callconv(.Inline) void {
    sdtx_pos(x, y);
}
pub extern fn sdtx_pos_x(f32) void;
pub fn posX(x: f32) callconv(.Inline) void {
    sdtx_pos_x(x);
}
pub extern fn sdtx_pos_y(f32) void;
pub fn posY(y: f32) callconv(.Inline) void {
    sdtx_pos_y(y);
}
pub extern fn sdtx_move(f32, f32) void;
pub fn move(dx: f32, dy: f32) callconv(.Inline) void {
    sdtx_move(dx, dy);
}
pub extern fn sdtx_move_x(f32) void;
pub fn moveX(dx: f32) callconv(.Inline) void {
    sdtx_move_x(dx);
}
pub extern fn sdtx_move_y(f32) void;
pub fn moveY(dy: f32) callconv(.Inline) void {
    sdtx_move_y(dy);
}
pub extern fn sdtx_crlf() void;
pub fn crlf() callconv(.Inline) void {
    sdtx_crlf();
}
pub extern fn sdtx_color3b(u8, u8, u8) void;
pub fn color3b(r: u8, g: u8, b: u8) callconv(.Inline) void {
    sdtx_color3b(r, g, b);
}
pub extern fn sdtx_color3f(f32, f32, f32) void;
pub fn color3f(r: f32, g: f32, b: f32) callconv(.Inline) void {
    sdtx_color3f(r, g, b);
}
pub extern fn sdtx_color4b(u8, u8, u8, u8) void;
pub fn color4b(r: u8, g: u8, b: u8, a: u8) callconv(.Inline) void {
    sdtx_color4b(r, g, b, a);
}
pub extern fn sdtx_color4f(f32, f32, f32, f32) void;
pub fn color4f(r: f32, g: f32, b: f32, a: f32) callconv(.Inline) void {
    sdtx_color4f(r, g, b, a);
}
pub extern fn sdtx_color1i(u32) void;
pub fn color1i(rgba: u32) callconv(.Inline) void {
    sdtx_color1i(rgba);
}
pub extern fn sdtx_putc(u8) void;
pub fn putc(c: u8) callconv(.Inline) void {
    sdtx_putc(c);
}
pub extern fn sdtx_puts([*c]const u8) void;
pub fn puts(str: [:0]const u8) callconv(.Inline) void {
    sdtx_puts(@ptrCast([*c]const u8,str));
}
pub extern fn sdtx_putr([*c]const u8, i32) void;
pub fn putr(str: [:0]const u8, len: i32) callconv(.Inline) void {
