...
// };
// 
pub const drmp3_t = extern struct {
    decoder: c.drmp3dec,
    channels: u32,
    sampleRate: u32,
    onRead: c.drmp3_read_proc,
    onSeek: c.drmp3_seek_proc,
    pUserData: *anyopaque,
    allocationCallbacks: c.drmp3_allocation_callbacks,
    mp3FrameChannels: u32,
    mp3FrameSampleRate: u32,
    pcmFramesConsumedInMP3Frame: u32,
    pcmFramesRemainingInMP3Frame: u32,
    pcmFrames: [@sizeOf(f32)*c.DRMP3_MAX_SAMPLES_PER_FRAME]u8,
    currentPCMFrame: u64,
    streamCursor: u64,
    pSeekPoints: c.drmp3_seek_point,
    seekPointCount: u32,
    dataSize: usize,
    dataCapacity: usize,
    dataConsumed: usize,
